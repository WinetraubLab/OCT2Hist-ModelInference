...
def setup_network():
    ...
    _run_subprocess(f'cp "{model_folder}/latest_net_G.pth" {base_folder}/checkpoints/pix2pix/')
    _run_subprocess(f'cp "{model_folder}/latest_net_D.pth" {base_folder}/checkpoints/pix2pix/')