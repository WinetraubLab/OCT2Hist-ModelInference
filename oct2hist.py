...
def setup_network():
    pix2pix.setup_network(
        "/Users/dannybarash/Code/oct/zero_shot_segmentation_test_sam/OCT2Hist_UseModel/pytorch_CycleGAN_and_pix2pix/checkpoints/segment_skin/latest_net_G.pth",
        "oct2hist")
...
def run_network(oct_image,
    ...
    if appy_resolution_matching:
        ...
        o2h_input = cv2.resize(oct_image, [target_height, target_width], interpolation=cv2.INTER_AREA)
    else:
        o2h_input = oct_image
